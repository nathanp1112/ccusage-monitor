...
export interface TokenRainSceneProps {
  totalCost: number
  totalTokens: number
}
...
function StatOverlay({ totalCost, totalTokens }: { totalCost: number; totalTokens: number }) {
  const cost = useAnimatedCounter(totalCost, 2500)
  const tokens = useAnimatedCounter(totalTokens, 3000)
...
// ---------------------------------------------------------------------------
// TokenRainScene Component
// ---------------------------------------------------------------------------

export function TokenRainScene({ totalCost, totalTokens }: TokenRainSceneProps) {
  return (
    <div
      style={{
        position: 'relative',
    ...
    >
      <StatOverlay totalCost={totalCost} totalTokens={totalTokens} />
      <Canvas
        shadows
